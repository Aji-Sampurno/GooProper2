...
public class ClosingAdminFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvlist = root.findViewById(R.id.RVClosingListAdmin);
        rvgrid = root.findViewById(R.id.RVClosingGridAdmin);
        srlistingadmin = root.findViewById(R.id.SRClosingAdmin);
        ivgrid = root.findViewById(R.id.IVGridClosingAdmin);
        ...
        rvgrid.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
        adapter = new ListingClosingAdapter(getActivity(), list);
    ...
    private void LoadListing(boolean showProgressDialog) {
        PDListingAdmin.setMessage("Memuat Listingan...");
        PDListingAdmin.show();
