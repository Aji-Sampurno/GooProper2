...
public class ListingAgenFragment extends Fragment {

    ProgressDialog PDListingAgen;
    ImageView IVSortAsc, IVSortDesc, IVFilter;
    SwipeRefreshLayout srlistingagen;
    RecyclerView rvlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_listing_agen, container, false);

        PDListingAgen = new ProgressDialog(getActivity());
        rvlist = root.findViewById(R.id.RVListingListAgen);
        srlistingagen = root.findViewById(R.id.SRListingAgen);
        ...
        srlistingagen.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_LISTING, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        PDListingAgen.cancel();
                        srlistingagen.setRefreshing(false);
                        list.clear();
