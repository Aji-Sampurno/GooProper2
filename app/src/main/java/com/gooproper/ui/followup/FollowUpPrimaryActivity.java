...
public class FollowUpPrimaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_follow_up_primary);

        PDFollowUp = new ProgressDialog(FollowUpPrimaryActivity.this);
        ...
        String intentIdListingPrimary = data.getStringExtra("IdListing");
        ...
        BuyerIdAgen = "0";
        BuyerIdListing = intentIdListingPrimary;
    ...
    private void AddFlowup() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerApi.URL_ADD_FLOWUP_PRIMARY, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("IdFlowupPrimary", BuyerIdListing);
