...
public class ListingkuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listingku);
        ...
        PDListingKu = new ProgressDialog(ListingkuActivity.this);
        srlistingku = findViewById(R.id.SRListingKu);
        rvlist = findViewById(R.id.RVListingKu);

        list = new ArrayList<>();

        rvlist.setLayoutManager(new LinearLayoutManager(ListingkuActivity.this, LinearLayoutManager.VERTICAL, false));
            ...
            public void onClick(View v) {
                ...
                if (!minPriceStr.isEmpty() && !maxPriceStr.isEmpty()) {
                    if (minPrice <= maxPrice) {
                        ...
                        Toast.makeText(ListingkuActivity.this, "Batas Harga Salah", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void LoadListing(boolean showProgressDialog) {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_LISTING_AGEN+ Preferences.getKeyIdAgen(ListingkuActivity.this),null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0 ; i < response.length(); i++)
                        {
                            try {
                                ...
                                Dialog customDialog = new Dialog(ListingkuActivity.this);
