...
public class PraListingRejectedAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pra_listing_rejected_admin);
        ...
        PDRejected = new ProgressDialog(PraListingRejectedAdminActivity.this);

        srrejected = findViewById(R.id.SRRejected);
        rvgrid = findViewById(R.id.RVListRejected);
        list = new ArrayList<>();

        rvgrid.setLayoutManager(new LinearLayoutManager(PraListingRejectedAdminActivity.this, LinearLayoutManager.VERTICAL, false));
            ...
            public void onClick(View v) {
                ...
                if (!minPriceStr.isEmpty() && !maxPriceStr.isEmpty()) {
                    if (minPrice <= maxPrice) {
                        ...
                        Toast.makeText(PraListingRejectedAdminActivity.this, "Invalid price range", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void LoadListing(boolean showProgressDialog) {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_REJECTED,null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0 ; i < response.length(); i++)
                        {
                            try {
                                ...
                                Dialog customDialog = new Dialog(PraListingRejectedAdminActivity.this);
