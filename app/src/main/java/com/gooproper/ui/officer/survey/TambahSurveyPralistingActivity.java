...
public class TambahSurveyPralistingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDialog = new ProgressDialog(TambahSurveyPralistingActivity.this);
        ...
        String intentIdListing = data.getStringExtra("IdPraListing");

        StrIdListing = intentIdListing;

        StrIdAgen = Preferences.getKeyIdAgen(TambahSurveyPralistingActivity.this);
        StrNamaAgen = Preferences.getKeyUsername(TambahSurveyPralistingActivity.this);
        StrKinerja = "Recheck";
        ...
        builder.setTitle("Unggah Gambar")
                .setItems(new CharSequence[]{"Ambil Foto", "Pilih Dari Galeri"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                ActivityCompat.requestPermissions(TambahSurveyPralistingActivity.this, new String[]{Manifest.permission.CAMERA}, CODE_CAMERA_REQUEST1);
                                break;
                            case 1:
        ...
        builder.setTitle("Unggah Gambar")
                .setItems(new CharSequence[]{"Ambil Foto", "Pilih Dari Galeri"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                ActivityCompat.requestPermissions(TambahSurveyPralistingActivity.this, new String[]{Manifest.permission.CAMERA}, CODE_CAMERA_REQUEST2);
                                break;
                            case 1:
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_CODE_EXTERNAL_STORAGE_1) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TambahSurveyPralistingActivity.this);
            ...
            ImgProperty.putFile(UriProperty)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ImgProperty.getDownloadUrl()
                                    ...
                                    .addOnFailureListener(exception -> {
                                        handleImage1Success();
                                        Toast.makeText(TambahSurveyPralistingActivity.this, "Upload failed: " + exception.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            handleImage1Success();
                            Toast.makeText(TambahSurveyPralistingActivity.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            StrImageProperty = "0";
    ...
    private void simpanData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerApi.URL_TAMBAH_CEK_SURVEY,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("Sukses")) {
                                Dialog customDialog = new Dialog(TambahSurveyPralistingActivity.this);
                                ...
                                dialogTitle.setText("Berhasil Menambahkan Survey");
                                ...
                                Glide.with(TambahSurveyPralistingActivity.this)
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("IdPraListing", StrIdListing);
