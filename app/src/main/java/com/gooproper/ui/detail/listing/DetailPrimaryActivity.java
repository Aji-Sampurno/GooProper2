...
import com.gooproper.ui.edit.primary.EditPrimaryActivity;
...
public class DetailPrimaryActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnEdit = findViewById(R.id.BtnEditPrimary);
        ...
        BtnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent update = new Intent(DetailPrimaryActivity.this, EditPrimaryActivity.class);
                update.putExtra("IdListing", intentIdListingPrimary);
                update.putExtra("IdListingPrimary", intentIdListingPrimary);
                update.putExtra("JudulListingPrimary", intentJudulListingPrimary);
                update.putExtra("HargaListingPrimary", intentHargaListingPrimary);
                update.putExtra("DeskripsiListingPrimary", intentDeskripsiListingPrimary);
                update.putExtra("AlamatListingPrimary", intentAlamatListingPrimary);
                update.putExtra("LatitudeListingPrimary", intentLatitudeListingPrimary);
                update.putExtra("LongitudeListingPrimary", intentLongitudeListingPrimary);
                update.putExtra("LocationListingPrimary", intentLocationListingPrimary);
                update.putExtra("KontakPerson1", intentKontakPerson1);
                update.putExtra("KontakPerson2", intentKontakPerson2);
