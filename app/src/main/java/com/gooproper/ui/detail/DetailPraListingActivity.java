...
public class DetailPraListingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (intentIsManager.equals("0")) {
                ...
                IVEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent update = new Intent(DetailPraListingActivity.this, EditListingActivity.class);
                ...
                IVEdit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent update = new Intent(DetailPraListingActivity.this, EditListingAgenActivity.class);
                        update.putExtra("IdPraListing", idpralisting);
                        update.putExtra("IdListing", intentIdListing);
                        update.putExtra("IdAgen", intentIdAgen);
                        update.putExtra("IdInput", intentIdInput);
            ...
            if (intentLatitude.equals("0") && intentLongitude.equals("0")) {
                if (intentIsManager.equals("0")) {
                    ...
                    IVEdit.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent update = new Intent(DetailPraListingActivity.this, EditPraListingAgenActivity.class);
                            update.putExtra("IdPraListing", idpralisting);
                            update.putExtra("IdListing", intentIdListing);
                            update.putExtra("IdAgen", intentIdAgen);
                    ...
                    BtnTambahMaps.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent update = new Intent(DetailPraListingActivity.this, EditPralistingActivity.class);
                            update.putExtra("IdPraListing", idpralisting);
                            update.putExtra("Selfie", intentSelfie);
                            startActivity(update);
                        }
                    ...
                    if (StrIdAgen.equals(intentIdAgen)) {
                        ...
                        BtnTambahMaps.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent update = new Intent(DetailPraListingActivity.this, EditMapsListingActivity.class);
                ...
                if (intentIsManager.equals("0")) {
                    ...
                    BtnTambahSelfie.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent update = new Intent(DetailPraListingActivity.this, TambahSelfieActivity.class);
                            update.putExtra("IdPraListing", idpralisting);
                            startActivity(update);
                        }
                    });
                    ...
                    if (StrIdAgen.equals(intentIdAgen)) {
                        ...
                        BtnTambahSelfie.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent update = new Intent(DetailPraListingActivity.this, TambahSelfieListingActivity.class);
                                update.putExtra("IdListing", idlisting);
                                startActivity(update);
                            }
                        });
        ...
        IVFlowUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent update = new Intent(DetailPraListingActivity.this, FollowUpActivity.class);
                update.putExtra("IdListing", intentIdListing);
                update.putExtra("IdAgen", intentIdAgen);
                startActivity(update);
            }
