...
public class NewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivgrid = findViewById(R.id.IVGridNew);
        srnew = findViewById(R.id.SRNew);
        rvgrid = findViewById(R.id.RVListingGridNew);
        rvlist = findViewById(R.id.RVListingListNew);

        list = new ArrayList<>();

        rvgrid.setLayoutManager(new GridLayoutManager(NewActivity.this,2));
        ...
        ivgrid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isGridChanged) {
                    AnimatorSet animatorSet = (AnimatorSet) AnimatorInflater.loadAnimator(NewActivity.this, R.animator.crossfade);
    ...
    private void LoadListing(boolean showProgressDialog) {
        PDNew.setMessage("Memuat Data Listig Sold...");
        PDNew.show();
        if (showProgressDialog) PDNew.show();
        else PDNew.cancel();

        RequestQueue queue = Volley.newRequestQueue(this);
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_LISTING_NEW,null,
