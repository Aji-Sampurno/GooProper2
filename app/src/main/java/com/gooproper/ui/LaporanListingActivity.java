...
public class LaporanListingActivity extends AppCompatActivity {
    ...
    Button BtnUnduhPralisting, BtnUnduh, BtnUnduhInfo, BtnUnduhAgen, BtnUnduhSusulan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnUnduhPralisting = findViewById(R.id.BtnUnduhPralisting);
        ...
        BtnUnduhSusulan = findViewById(R.id.BtnUnduhSusulan);
        ...
        BtnUnduhPralisting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fetchDataPralistingAndCreateExcel();
            }
        });
        ...
        BtnUnduhSusulan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fetchDataSusulanAndCreateExcel();
            }
        });
    ...
    private void fetchDataPralistingAndCreateExcel() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_LAPORAN_PRALISTING,null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            String filename = "PraListing_" +  new SimpleDateFormat("yyMMddHH", Locale.getDefault()).format(new Date(currentTimeMillis)) + ".xls";
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String IdListing = jsonObject.getString("IdPraListing");
...
//                                Date date = dateFormat.parse(TglInput);
    ...
    private void fetchDataSusulanAndCreateExcel() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_GET_LAPORAN_SUSULAN,null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            long currentTimeMillis = System.currentTimeMillis();
                            long adjustedTimeMillis = currentTimeMillis - (currentTimeMillis % (24 * 60 * 60 * 1000)) + (9 * 60 * 60 * 1000);
                            String filename = "Susulan_" +  new SimpleDateFormat("yyMMddHH", Locale.getDefault()).format(new Date(currentTimeMillis)) + ".xls";
                            File outFile = new File(directory, filename);
                            ...
                            sheet.addCell(new Label(0, 0, "NO"));
                            sheet.addCell(new Label(1, 0, "ALAMAT LISTING"));
                            sheet.addCell(new Label(2, 0, "AGEN"));
                            sheet.addCell(new Label(3, 0, "POIN TAMBAHAN"));
                            sheet.addCell(new Label(4, 0, "POIN BERKURANG"));
                            sheet.addCell(new Label(5, 0, "KETERANGAN"));
                            sheet.addCell(new Label(6, 0, "TANGGAL INPUT"));

                            for (int i = 0; i < response.length(); i++) {
                                JSONObject jsonObject = response.getJSONObject(i);

                                String Keterangan = jsonObject.getString("Keterangan");
                                String PoinTambah = jsonObject.getString("PoinTambahan");
                                String PoinKurang = jsonObject.getString("PoinBerkurang");
                                String Alamat = jsonObject.getString("Alamat");
                                String Agen = jsonObject.getString("KodeAgen");
                                String TanggalInput = jsonObject.getString("TglInput");
                                String No = String.valueOf(i + 1);

                                sheet.addCell(new Label(0, i + 1, No));
                                sheet.addCell(new Label(1, i + 1, Alamat));
                                sheet.addCell(new Label(2, i + 1, Agen));
                                sheet.addCell(new Label(3, i + 1, PoinTambah));
                                sheet.addCell(new Label(4, i + 1, PoinKurang));
                                sheet.addCell(new Label(5, i + 1, Keterangan));
                                sheet.addCell(new Label(6, i + 1, TanggalInput));
                            }
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            sheet.addCell(new Label(5, 0, "STATUS NARAHUBUNG"));
                            sheet.addCell(new Label(6, 0, "AGEN KANTOR LAIN / OWNER"));
                            sheet.addCell(new Label(7, 0, "LOKASI"));
                            sheet.addCell(new Label(8, 0, "ALAMAT"));
                            sheet.addCell(new Label(9, 0, "TANGGAL INPUT"));
                            sheet.addCell(new Label(10, 0, "JAM INPUT"));
                            sheet.addCell(new Label(11, 0, "LUAS BANGUNAN"));
                            sheet.addCell(new Label(12, 0, "LUAS TANAH"));
                            sheet.addCell(new Label(13, 0, "HARGA JUAL"));
                            sheet.addCell(new Label(14, 0, "HARGA SEWA"));
                            sheet.addCell(new Label(15, 0, "KETERANGAN"));
                            sheet.addCell(new Label(16, 0, "NAMA AGEN"));
                            sheet.addCell(new Label(17, 0, "POIN"));
                            sheet.addCell(new Label(18, 0, "STATUS LISTING"));
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String StatusNarahubung = jsonObject.getString("StatusNarahubung");
                                ...
                                sheet.addCell(new Label(5, i + 1, StatusNarahubung));
                                sheet.addCell(new Label(6, i + 1, Lokasi));
                                sheet.addCell(new Label(7, i + 1, Alamat));
                                sheet.addCell(new Label(8, i + 1, TglInput));
                                sheet.addCell(new Label(9, i + 1, JamInput));
                                sheet.addCell(new Label(10, i + 1, LBangunan));
                                sheet.addCell(new Label(11, i + 1, LTanah));
                                sheet.addCell(new Label(12, i + 1, Harga));
                                sheet.addCell(new Label(13, i + 1, HargaSewa));
                                sheet.addCell(new Label(14, i + 1, Keterangan));
                                sheet.addCell(new Label(15, i + 1, Nama));
                                sheet.addCell(new Label(16, i + 1, String.valueOf(Poin)));
                                sheet.addCell(new Label(17, i + 1, IsListing));
                            }
