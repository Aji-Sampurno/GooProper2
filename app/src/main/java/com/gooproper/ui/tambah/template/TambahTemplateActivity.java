...
public class TambahTemplateActivity extends AppCompatActivity {
    ...
    String StrIdPraListing, TemplateFull, TemplateBlank;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_template);

        pDialog = new ProgressDialog(TambahTemplateActivity.this);
        ...
        Submit.setOnClickListener(view -> {
            if (UriTemplateFull == null) {
                Dialog customDialog = new Dialog(TambahTemplateActivity.this);
                ...
                Glide.with(TambahTemplateActivity.this)
            ...
            ImageTemplateFull.putFile(UriTemplateFull)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ImageTemplateFull.getDownloadUrl()
                                    ...
                                    .addOnFailureListener(exception -> {
                                        handleImageTemplateFull();
                                        Toast.makeText(TambahTemplateActivity.this, "Upload failed: " + exception.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            handleImageTemplateFull();
                            Toast.makeText(TambahTemplateActivity.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            TemplateFull = "0";
    ...
    private void simpanData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerApi.URL_UPLOAD_TEMPLATE,
