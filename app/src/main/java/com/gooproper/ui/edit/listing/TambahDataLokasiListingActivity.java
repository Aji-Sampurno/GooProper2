...
public class TambahDataLokasiListingActivity extends AppCompatActivity {
    ...
    Uri UriSelfie;
    String intentIdListing, intentSelfie, intentPoinTambah;
    String latitudeStr, longitudeStr, addressStr,lokasiStr, Selfie, Keterangan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_data_lokasi_listing);

        pDialog = new ProgressDialog(TambahDataLokasiListingActivity.this);
        ...
        intentPoinTambah = data.getStringExtra("PoinTambah");
        ...
        submit.setOnClickListener(view -> {
            if (Validate()) {
                if (UriSelfie == null && (intentSelfie.equals("0") || intentSelfie.isEmpty())) {
                    Dialog customDialog = new Dialog(TambahDataLokasiListingActivity.this);
                    ...
                    Glide.with(TambahDataLokasiListingActivity.this)
        ...
        builder.setTitle("Unggah Gambar")
                .setItems(new CharSequence[]{"Ambil Foto", "Pilih Dari Galeri"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                ActivityCompat.requestPermissions(TambahDataLokasiListingActivity.this, new String[]{Manifest.permission.CAMERA}, CODE_CAMERA_REQUEST_Selfie);
                                break;
                            case 1:
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_CODE_EXTERNAL_STORAGE_SELFIE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TambahDataLokasiListingActivity.this);
            ...
            ImageSelfie.putFile(UriSelfie)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ImageSelfie.getDownloadUrl()
                                    ...
                                    .addOnFailureListener(exception -> {
                                        handleImageSelfieSuccess();
                                        Toast.makeText(TambahDataLokasiListingActivity.this, "Upload failed: " + exception.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            HideProgressDialog();
                            handleImageSelfieSuccess();
                            Toast.makeText(TambahDataLokasiListingActivity.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            Selfie = intentSelfie;
    ...
    private void simpanData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerApi.URL_UPDATE_DATA_LOKASI_LISTING,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String Keterangan = "Tambah Lokasi dan Selfie";
                ...
                map.put("PoinTambahan", intentPoinTambah);
    ...
    public boolean Validate() {
        if (latitude.getText().toString().equals("")) {
            latitude.setError("Harap Isi Lokasi");
