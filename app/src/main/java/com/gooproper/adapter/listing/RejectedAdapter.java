...
public class RejectedAdapter extends RecyclerView.Adapter<RejectedAdapter.HolderData> {
    ...
    public RejectedAdapter(Context context, List<ListingModel> list){
        this.models = list;
    ...
    @NonNull
    @Override
    public RejectedAdapter.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        public HolderData(View view){
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    update.putExtra("Keterangan",listingModel.getKeterangan());
