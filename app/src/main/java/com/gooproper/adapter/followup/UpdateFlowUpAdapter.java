...
public class UpdateFlowUpAdapter extends RecyclerView.Adapter<UpdateFlowUpAdapter.HolderData> {

    private List<UpdateFlowUpModel> models;
    private Context context;

    public UpdateFlowUpAdapter(Context context, List<UpdateFlowUpModel> list){
        this.models = list;
    ...
    @NonNull
    @Override
    public UpdateFlowUpAdapter.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
